...
const SignUp = ({onLogin}) => {
    ...
    return (
        <div className="flex justify-center items-center min-h-screen  bg-gray-100">
            <div
                className="bg-white rounded-lg shadow-xl w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-[85rem] h-[35rem] flex">
                {/* Left Section */}
                <div
                    className="w-1/2 h-full bg-white rounded-l-lg flex flex-col justify-center items-center p-8 sm:p-16 lg:p-44">
                    ...
                    <div className="w-full flex flex-col justify-center items-center max-w-sm space-y-6 mt-3">
                        ...
                        <div className="flex justify-center items-center">
                            <button onClick={handleGoogleLogin}
                                    className="w-12 h-12 p-2 rounded-full bg-white hover:bg-gray-200 focus:ring-2 focus:ring-blue-500 font-semibold">
                                <img
                                    src={googleIcon}
                                    alt="Google logo"
