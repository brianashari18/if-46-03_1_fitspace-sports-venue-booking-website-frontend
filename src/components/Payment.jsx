...
const Payment = () => {
  ...
  const calculateProgress = () => {
    ...
    // Progress untuk field yang diisi
    let progressValue = (filledFields / requiredFields.length) * 50; // 50% untuk form
    // Tambahkan 50% jika payment method dipilih
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4">
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("BCA")}
                />
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("BNI")}
                />
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("Mandiri")}
                />
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("BRI")}
                />
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("BSI")}
                />
              </div>
              <div className="bg-[#E6FDA3] p-1 rounded-lg">
                <span className="block text-black font-semibold pl-2">
              ...
              <div className="flex gap-4">
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("Gopay")}
                />
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("Ovo")}
                />
                <img
                  ...
                  onClick={() => handlePaymentMethodClick("ShopeePay")}
                />
              </div>
              <div className="bg-[#E6FDA3] p-1 rounded-lg">
                <span className="block text-black font-semibold pl-2">
